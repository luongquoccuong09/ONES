...
namespace ONES
{
    ...
    public class OverrideYellow : IExternalCommand
    {
        // Token: 0x0600023C RID: 572 RVA: 0x0002545C File Offset: 0x0002365C
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            Color color = new Color(byte.MaxValue, byte.MaxValue, 0);
