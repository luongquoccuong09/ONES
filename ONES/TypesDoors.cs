...
namespace ONES
{
    ...
    public class TypesDoors : IExternalCommand
    {
        // Token: 0x0600022A RID: 554 RVA: 0x00024210 File Offset: 0x00022410
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            FilteredElementCollector filteredElementCollector = new FilteredElementCollector(document).OfCategory(BuiltInCategory.OST_Doors).WhereElementIsElementType();
            ...
            try
            {
                using (Transaction transaction = new Transaction(document, "Door Types"))
                {
                    transaction.Start();
